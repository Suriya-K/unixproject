#! /bin/bash
# A simple menu demo using the built-in menu feature from select

declare -a MENU    # declare associative array MENU
                   # and populate it with our menu choices
MENU=("Eat" "Drink" "Sleep" "Play with phone" "Procrastinate" "Hesitate" "Study")

OLDPS3="${PS3}"    # backup current PS3 prompt
PS3="What do you want to do?"  # set our own PS3 prompt
...
case ${REPLY} in   # respond to choice with a message corresponding to each menu choice
  1) printf "Get some Mama noodles....\n"
     ;;
